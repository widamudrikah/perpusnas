                ...
                <table class="w-full border-collapse" id="categoryTable">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr class="border-b border-gray-50 hover:bg-gray-50 transition-colors duration-150 category-row"
                            data-name="pemrograman">
                            <td class="px-6 py-4 text-xs text-gray-400">1</td>
                            <td class="px-6 py-4"><span class="text-sm font-semibold text-gray-800">Pemrograman</span></td>
                            <td class="px-6 py-4">
                                <code
                                    class="text-xs bg-gray-100 text-gray-500 px-2.5 py-1 rounded-lg font-mono">pemrograman</code>
                            </td>
                            <td class="px-6 py-4">
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
            ...
            <form class="px-6 py-5 flex flex-col gap-4">
                ...
                <div>
                    ...
                    <input type="text" placeholder="Contoh: Pemrograman"
